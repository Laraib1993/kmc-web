...
Partial Class specialbill20
    ...
    Private Sub BindReport()
        Try
            ...
            rpt.Load(Server.MapPath("~/reports/specialbill20MUCTBill.rpt"))
            ...
            rpt.RecordSelectionFormula = "{invoice.consumer_no} = '" & txtconsumerno.Text.ToString & "' and {invoice.status} = 7"
    ...
    Protected Sub btnins_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            con.Open()
            cmd1 = New SqlCommand("insert into duplicatebill_history  (Consumer_No,Category,zone, bill_type,createdby, createdon) SELECT  consumer_no, category,zone,'20 Days Complete Bill Date by MUCT Employee', '" & se & "', GETDATE()FROM invoice WHERE  consumer_no = '" & txtconsumerno.Text & "'", con)
