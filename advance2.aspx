<%@ Page Title="" Language="VB" MasterPageFile="~/webinventory.master" AutoEventWireup="false" CodeFile="advance2.aspx.vb" Inherits="advance2" %>
      ...
      <div align="center">
             <div style="background-color:#546879;padding: 5px; margin: 10px 20px 10px 20px; border: 2px solid #C0C0C0;border-radius: 10px; -moz-border-radius: 10px;-webkit-border-radius: 10px;width:240px;">
                <table cellpadding="0" cellspacing="0" align="center" width="100%">
                       ...
                       <tr>
                        <td>
                            <label style="color:white">Employee Muct</label>
                            <select id="ddlemployee" runat="server" required>
                     ...
                     <tr>
                        <td>
                            ...
                            <textarea id="txtdescription" cols="20" rows="3"
                                runat="server">
