...
Partial Class daily_collection
    ...
    Sub BindReport()
        ...
        dailyreport.SeparatePages = False
        ...
        crit = "{posting_voucher.Payment_Date}>=#" & Format(CDate(Request.QueryString("fromdate")), "MM/dd/yyyy") & "#"
        crit = crit & " and {posting_voucher.Payment_Date} <=#" & Format(CDate(Request.QueryString("todate")), "MM/dd/yyyy") & "#"
